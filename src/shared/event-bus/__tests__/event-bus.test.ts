...
import { toId, type PaymentRequestId, type JournalEntryId } from '../../types/brand.types'
...
describe('TypedEventBus', () => {
  ...
  it('should return unsubscribe function', () => {
    ...
    eventBus.emit('payment-request:submitted', { id: toId<PaymentRequestId>('1') })
    expect(callCount).toBe(1)

    unsub()
    eventBus.emit('payment-request:submitted', { id: toId<PaymentRequestId>('2') })
