...
export default [
  // --- Payment Requests ---
  {
    ...
    component: () =>
      import("./ui/payment-requests/pages/PaymentRequestsListPage.vue"),
  },
  {
    path: "requests/create",
    name: "PaymentRequestCreate",
    component: () =>
      import("./ui/payment-requests/pages/PaymentRequestCreatePage.vue"),
  },
  {
    path: "requests/:id",
    name: "PaymentRequestDetail",
    component: () =>
      import("./ui/payment-requests/pages/PaymentRequestDetailPage.vue"),
    props: true,
  },
