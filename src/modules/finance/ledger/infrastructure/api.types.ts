...
export type AccountCreateDTO = components["schemas"]["AccountCreate"];
export type AccountRenameDTO = components["schemas"]["AccountRename"];
...
export type JournalEntryVoidDTO = components["schemas"]["JournalEntryVoid"];
