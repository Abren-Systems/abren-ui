...
const settingColumns = [
  ...
  },
  {
    ...
    cell: ({ row }: { row: { original: { value: string | null } } }) => row.original.value || "Default",
  },
];
</script>
    ...
    <header class="flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-muted-foreground mt-1">
          Configure system-wide parameters and module thresholds for your
          organisation.
        </p>
      </div>
      <Button v-if="hasPermission('core:tenant_edit')" variant="outline">
        Bulk Edit
      </Button>
    </header>
